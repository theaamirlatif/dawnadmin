...
const CertificateThirtyEight = () => {
    ...
    const [otherParameters, setOtherParameters] = useState([{ appliedValue: "", observedValue: "", deviation: "", uncertainty: "" }]);
    ...
    const handleAddClick = () => {
        setOtherParameters([...otherParameters, { appliedValue: "", observedValue: "", deviation: "", uncertainty: "" }]);
    };
    ...
    async function Submit() {
        ...
        formData.append('ac_other_parameters', JSON.stringify(otherParameters))
        formData.append('trace_measure', traceMeasure)

        let result = await fetch(window.api + "addThirtyEightCertificate", {
            method: 'POST',
            body: formData
        });
                ...
                <div className="card-body">
                    ...
                    */}
                    ...
                    <div className='row'>
                        ...
                        <div className='col-sm-3'>
                            <label>Average Value on the Unit Under Calibration</label>
                        </div>
                        <div className='col-sm-3'>
                            <label>Error</label>
                        </div>
...
export default CertificateThirtyEight